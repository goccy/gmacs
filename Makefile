...
# Generated by qmake (2.01a) (Qt 4.6.2) on: ? 5 ? 20 17:36:24 2011
# Project:  gmacs.pro
# Template: app
...
SOURCES       = src/line_field.cpp \
		src/main.cpp \
		src/script.cpp \
		src/syntax.cpp \
		src/text_field.cpp 
OBJECTS       = line_field.o \
		main.o \
		script.o \
		syntax.o \
		text_field.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/gmacs1.0.0/ && $(COPY_FILE) --parents include/gmacs.hpp .tmp/gmacs1.0.0/ && $(COPY_FILE) --parents src/line_field.cpp src/main.cpp src/script.cpp src/syntax.cpp src/text_field.cpp .tmp/gmacs1.0.0/ && (cd `dirname .tmp/gmacs1.0.0` && $(TAR) gmacs1.0.0.tar gmacs1.0.0 && $(COMPRESS) gmacs1.0.0.tar) && $(MOVE) `dirname .tmp/gmacs1.0.0`/gmacs1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/gmacs1.0.0
