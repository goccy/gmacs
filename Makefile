...
# Generated by qmake (2.01a) (Qt 4.6.2) on: ? 6 ? 3 23:46:06 2011
# Project:  gmacs.pro
# Template: app
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.6.2/mkspecs/macx-g++ -I. -I/usr/local/Trolltech/Qt-4.6.2/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Trolltech/Qt-4.6.2/include/QtCore -I/usr/local/Trolltech/Qt-4.6.2/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Trolltech/Qt-4.6.2/include/QtGui -I/usr/local/Trolltech/Qt-4.6.2/include -I. -Iinclude -I. -F/usr/local/Trolltech/Qt-4.6.2/lib
LINK          = g++
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/gmacs1.0.0/ && $(COPY_FILE) --parents include/gmacs.hpp .tmp/gmacs1.0.0/ && $(COPY_FILE) --parents src/completion.cpp src/line_field.cpp src/main.cpp src/parse.cpp src/script.cpp src/syntax.cpp src/text_field.cpp src/token.cpp .tmp/gmacs1.0.0/ && (cd `dirname .tmp/gmacs1.0.0` && $(TAR) gmacs1.0.0.tar gmacs1.0.0 && $(COMPRESS) gmacs1.0.0.tar) && $(MOVE) `dirname .tmp/gmacs1.0.0`/gmacs1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/gmacs1.0.0
...
completion.o: src/completion.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o completion.o src/completion.cpp

line_field.o: src/line_field.cpp include/gmacs.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o line_field.o src/line_field.cpp

main.o: src/main.cpp include/gmacs.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o src/main.cpp

parse.o: src/parse.cpp include/gmacs.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o parse.o src/parse.cpp

script.o: src/script.cpp include/gmacs.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o script.o src/script.cpp

syntax.o: src/syntax.cpp include/gmacs.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o syntax.o src/syntax.cpp

text_field.o: src/text_field.cpp include/gmacs.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o text_field.o src/text_field.cpp

token.o: src/token.cpp include/gmacs.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o token.o src/token.cpp
